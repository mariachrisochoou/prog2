...
public class Menu implements ActionListener {
	...
	private static JButton b1, b3, b4;
	...
	public static void createMenu() {
		...
		b3 = new JButton("Show messages");
		b3.setBounds(70, 120, 180, 25);
		b3.setFocusable(false);
		panel.add(b3);
		
		b4 = new JButton("Log out");
		b4.setBounds(70, 150, 180, 25);
	...
	public static void logoutPerformed() {
		...
		label = new JLabel("You have successfully logged out!");
		label.setBounds(145,30,180,25);
		panel.add(label);
